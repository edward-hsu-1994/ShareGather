...
- **Entitlements File**: `Config/ShareGather.entitlements` contains all app capabilities
...
To add capabilities to your app, edit `Config/ShareGather.entitlements`:
